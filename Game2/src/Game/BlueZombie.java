...
public class BlueZombie extends GameObject{
    ...
    public BlueZombie(int x, int y, ID id, Player player, Main main, Handler handler) {
        super(x, y, id);
        this.player = player;
        this.main = main;
    ...
    public void calculateVelocity(int fromX, int fromY, int toX, int toY)
    {
        ...
        double speed = 3; //set the speed in [2,n)  n should be < 20 for normal speed
        //find Y
        if (distance != 0) {
